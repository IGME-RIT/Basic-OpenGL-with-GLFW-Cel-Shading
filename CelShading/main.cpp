...
int main(int argc, char **argv)
{
	...
	// Initialize window
	GLFWwindow* window = glfwCreateWindow(viewportDimensions.x, viewportDimensions.y, "Cel Shading", nullptr, nullptr);
    ...
    material->SetTexture((char*)"tex", new Texture((char*)"../assets/iron_buckler_diffuse.png"));
	...
	while (!glfwWindowShouldClose(window))
	{
        ...
        material->SetMatrix((char*)"cameraView", viewProjection);
        material->SetMatrix((char*)"worldMatrix", transform.GetMatrix());
        // Bind the material
        material->Bind();
        model->Draw();
